  ...
  <header>
    <div class="header-inner">
      ...
      <Nav>
        ...
        <a :class="{'nav-item': true, 'active': $route.name === 'heat'}">
            热点
        </a>
        <a :class="{'nav-item': true, 'active': $route.name === 'topic'}"  @click="$router.push({name: 'topic'})">
            话题
        </a>
      </Nav>
      ...
      <div class="userInfo" v-else>
        ...
        <Dropdown trigger="click">
          ...
          <DropdownMenu slot="list" class="userMenu">
            <DropdownItem><Button type="text" icon="person" @click="$router.push({name: 'profile'})">我的主页</Button></DropdownItem>
            <DropdownItem><Button type="text" icon="gear-b">设置</Button></DropdownItem>
